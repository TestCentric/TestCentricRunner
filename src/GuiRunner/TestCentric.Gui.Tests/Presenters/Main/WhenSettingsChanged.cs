...
namespace TestCentric.Gui.Presenters.Main
{
    internal class WhenSettingsChanged : MainPresenterTestBase
    {
        ...
        public void NUnitTreeGroupBy_SettingChanged_MenuItemIsUpdated(string groupBy)
        {
            ...
            _settings.Changed += Raise.Event<Model.Settings.SettingsEventHandler>(this, new SettingsEventArgs("TestCentric.Gui.TestTree.NUnitGroupBy"));
        ...
        public void FixtureListGroupBy_SettingChanged_MenuItemIsUpdated(string groupBy)
        {
            ...
            _settings.Changed += Raise.Event<Model.Settings.SettingsEventHandler>(this, new SettingsEventArgs("TestCentric.Gui.TestTree.FixtureList.GroupBy"));
        ...
        public void TestListGroupBy_SettingChanged_MenuItemIsUpdated(string groupBy)
        {
            ...
            _settings.Changed += Raise.Event<Model.Settings.SettingsEventHandler>(this, new SettingsEventArgs("TestCentric.Gui.TestTree.TestList.GroupBy"));
