...
static readonly FilePath[] TREE_ICONS_PNG = {
        "Success.png", "Failure.png", "Warning.png", "Ignored.png", "Inconclusive.png", "InTestRun.png", "Running.png", "Success_NotLatestRun.png", "Failure_NotLatestRun.png", "Warning_NotLatestRun.png", "Ignored_NotLatestRun.png", "Inconclusive_NotLatestRun.png", "Skipped.png" };
	...
	packageContent: new PackageContent()
		...
		.WithDirectories(
			...
			new DirectoryContent("tools/Images/Tree/Circles").WithFiles(
				...
				"Images/Tree/Circles/Running.png", "Images/Tree/Circles/InTestRun.png", "Images/Tree/Circles/Skipped.png"),
			new DirectoryContent("tools/Images/Tree/Classic").WithFiles(
				...
				"Images/Tree/Classic/Running.png", "Images/Tree/Classic/InTestRun.png", "Images/Tree/Classic/Skipped.png"),
			new DirectoryContent("tools/Images/Tree/Visual Studio").WithFiles(
				...
				"Images/Tree/Visual Studio/Running.png", "Images/Tree/Visual Studio/InTestRun.png", "Images/Tree/Visual Studio/Skipped.png") )
